...
def create_gantt_chart(user_tasks=None):
    tasks = [
            dict(Task="Planning", Start='2024-11-22', Finish='2024-11-24', Dependencies='-'),
            dict(Task="Initial Prototype Design", Start='2024-11-24', Finish='2024-11-26', Dependencies='Planning'),
            dict(Task="Front-End Development", Start='2024-11-26', Finish='2024-11-29', Dependencies='Initial Prototype Design'),
            dict(Task="Back-End Development", Start='2024-11-29', Finish='2024-12-01', Dependencies='Front-End Development'),
